...
export default function ModalLabs(props) {
    ...
    const handleClose = async (e) => {
        ...
        if (props.btnTitle === "Add") {
            ...
            await axios.post(`http://${process.env.REACT_APP_URL}/admin/createLab`, obj,
                {
                    headers: {
                ...
                if (notes.length < 10) {
                    alert("Title should be minimum 10 characters")
                }
                else {
            ...
            console.log(obj)
            await axios.put(`http://${process.env.REACT_APP_URL}/admin/updateLab?labId=${id}`, obj,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    }
    ...
    //         }
    //     await axios.post(`http://${process.env.REACT_APP_URL}/admin/createLabBranch`, obj,
    //             {
    //                 headers: {
    //                     Authorization: `Bearer ${token}`,
    //                 }
                        ...
                        <form onSubmit={(e) => handleClose(e)}>
                            ...
                            <div >

                                {
                                    ...
                                    <div class="my-3">
                                        <label for="exampleInputEmail1" class="form-label">LabID</label>
                                ...
                                <div class="my-3">
                                    ...
                                    <input style={{ width: '380px' }} onChange={(e) => setPno(e.target.value)} class="form-control" />
                                </div>
                                <div class="my-3">
                                    <label class="form-label">Access URL</label>
                                    <input style={{ width: '380px' }} type="url" onChange={(e) => setUrl(e.target.value)} class="form-control" />
                                </div>
                                <div class="my-3">
