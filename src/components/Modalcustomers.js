...
export default function ModalCustomers(props) {
    ...
    const handleClose = async (e) => {
        ...
        if (props.btnTitle === "Add") {
            ...
            await axios.post(`http://${process.env.REACT_APP_URL}/admin/createPanel`, obj,
                {
                    headers: {
            ...
            await axios.post(`http://${process.env.REACT_APP_URL}/admin/updatePanel`, obj,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    }
    ...
    return (
        <>
            ...
            {
                props.btnTitle === "Add" ? <Button className="ms-auto me-3 my-3" onClick={handleOpen} size='small' style={{ backgroundColor: 'darkCyan' }} variant="contained">Add</Button> :
                    ...
                    <Typography style={newstyle} id="modal-modal-description" sx={{ mt: 2 }}>
                        <form onSubmit={(e) => handleClose(e)}>
                            ...
                            <div >
                                ...
                                <div class="my-3">
                                    <label for="exampleInputEmail1" class="form-label">Cust ID</label>
                                ...
                                <div class="my-3">
                                    ...
                                    <input style={{ width: '380px' }} type='email' onChange={(e) => setURL(e.target.value)} class="form-control" />
                                </div>
                                <div class="my-3">
