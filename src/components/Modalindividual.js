...
export default function ModalIndividual(props) {
    ...
    const handleClose = async (e) => {
        ...
        if (props.btnTitle === "Add") {
            ...
            await axios.post(`http://${process.env.REACT_APP_URL}/admin/createIndividualTest`, obj,
                {
                    headers: {
            ...
            await axios.post(`http://${process.env.REACT_APP_URL}/admin/updateIndividualTest`, obj,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    }
                    ...
                    <Typography style={newstyle} id="modal-modal-description" sx={{ mt: 2 }}>
                        <form onSubmit={(e) => handleClose(e)}>
                            ...
                            <div >
                                ...
                                <div class="my-3">
                                    <label for="exampleInputEmail1" class="form-label">FKCategoryID</label>
                                ...
                                <div class="my-3">
                                    <label class="form-label">PK Test ID</label>
                                    <input style={{ width: '380px' }} onChange={(e) => setCDate(e.target.value)} class="form-control" />
                                </div>
                                <div class="my-3">
