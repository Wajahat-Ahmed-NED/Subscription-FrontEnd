...
import ModalLabs from './modalLabs';
...
export default function Alllabs() {
    ...
    return (
        <>
            <h1 className='text-center mb-3'>Labs Details</h1>
            <div className="container d-flex justify-content-flex-end">
                <ModalLabs btnTitle="Add" rows={rows} columns={columns} onClick={handleAdd} />
                {/* <ModalLabs btnTitle="Branch" rows={rows} columns={columns} onClick={handleAdd} /> */}
            </div>
                                        ...
                                        {columns.map((column) => {
                                            ...
                                            return (
                                                <TableCell key={column.id} align={column.align}>
                                                    {column.format && typeof value === 'number' ? column.format(value) : value === "Enabled" ? <CheckCircleIcon color="success" /> : column.label === "Action" ? <><ModalLabs btnTitle="Edit" rows={rows} columns={columns} />
                                                        <ModalLabs btnTitle="Delete" /> </> : value}
                                                </TableCell>
                                            );
                                        })}
                                    </TableRow>
